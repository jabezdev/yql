...
export default function PerformanceDashboard() {
    ...
    const cycles = useQuery(api.domains.hr.performanceReviews.getAllCycles, { status: "active" });
    const activeCycle = cycles?.[0];

    // Get my tasks
    const peerReviews = useQuery(api.domains.hr.performanceReviews.getMyPeerReviews, activeCycle ? { cycleId: activeCycle._id } : "skip");
    ...
    const summaryData = useQuery(api.domains.hr.performanceReviews.getPerformanceSummary,
