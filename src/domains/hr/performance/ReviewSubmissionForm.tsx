...
export default function ReviewSubmissionForm() {
    ...
    const submitSelf = useMutation(api.domains.hr.performanceReviews.submitSelfReview);
    const submitPeer = useMutation(api.domains.hr.performanceReviews.submitPeerReview);
    // const savePeer = useMutation(api.domains.hr.performanceReviews.savePeerReviewDraft);
