...
export default function ShiftCalendar() {
    const shifts = useQuery(api.domains.ops.events.getShifts, {});
    const userId = useQuery(api.core.users.getMe)?._id;
    const bookEvent = useMutation(api.domains.ops.events.bookEvent);
