...
interface SignatureBlockProps {
    ...
    value: any; // { signed: boolean, name: string, date: number }
    onChange: (value: any) => void;
    readOnly?: boolean;
}

export function SignatureBlock({ block, value, onChange, readOnly }: SignatureBlockProps) {
    ...
    const updateValue = (s: boolean, n: string) => {
        // If unchecked, clear value or set to null? 
        // Better to send the object state.
