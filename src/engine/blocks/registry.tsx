import type { BlockTypeKey } from "../../core/constants/blocks";
...
export const BLOCK_REGISTRY: Partial<Record<BlockTypeKey, BlockDefinition>> = {
    ...
    // Specialized HR Blocks (MOVED TO MODULES)
    /*
    department_selector, user_selector, goal_editor, timesheet_grid, etc.
