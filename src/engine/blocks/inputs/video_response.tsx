...
export const ParticipantView: React.FC<ApplicantViewProps> = ({ block, value, onChange, readOnly }) => {
    ...
    const savedUrl = useQuery(api.core.files.getFileUrl, value ? { storageId: value } : "skip");
...
export const ReviewerView: React.FC<ReviewerViewProps> = ({ block, applicantValue }) => {
    ...
    const savedUrl = useQuery(api.core.files.getFileUrl, applicantValue ? { storageId: applicantValue } : "skip");
