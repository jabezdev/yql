...
import StageRenderer from "../components/renderer/StageRenderer";
import { AdminProcessControls } from "../components/admin/AdminProcessControls";
...
export default function ProcessView() {
    ...
    const processData = useQuery(api.processes.getProcessWithAccess, { processId: processId as Id<"processes"> });
    ...
    const rawStages = useQuery(
        api.stages.getVisibleProgramStages,
